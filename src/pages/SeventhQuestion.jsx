...
const fifthQuestionData = fetchData('seventh_question/')

const FifthQuestion = () => {
    const data = fifthQuestionData.read()
    const top10 = data.slice(0, 3)
    return (
        <>
            <div
            ...
            <h2 className='flex items-center pt-10 pb-4 text-2xl font-semibold opacity-60 gap-x-2'>
                ...
                Top 3 de las institucuines con más estudiantes matriculados en el periodo 2020-2021
            </h2>
            ...
            <Grid numColsLg={6} className='gap-6 mt-6 mb-6'>
                    ...
                    <div className='flex flex-col h-full space-y-6'>
                        <Card className='flex-1'>
                            <div className='flex flex-col items-left justify-center h-full'>
                                <Title>Total matriculas</Title>

                                <Table className="mt-1">
                                    <TableHead>
                                        <TableRow>
                                            <TableHeaderCell>Instituciobnes</TableHeaderCell>
                ...
                <Col numColSpanLg={4}>
                    <BarChartComponent
                        data={top10}
                        title='Número de matriculados por departamento'
