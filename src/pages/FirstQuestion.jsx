    ...
    return (
        <>
            ...
            <h2 className='flex items-center pt-10 pb-4 text-2xl font-semibold opacity-60 gap-x-2'>
                ...
                Top 5 IE con mayor número de matriculados en los años 2020 y 2021 post pandemia
            </h2>
            <Card>
                <Table className="mt-1">
                    <TableHead>
                        <TableRow>
                            <TableHeaderCell>Nombre de la institucion</TableHeaderCell>
                    ...
                    <TableBody>
                        {top5.map((item) => (
                            <TableRow key={item.NOMBRE_ESTABLECIMIENTO}>
                                <TableCell>{item.NOMBRE_ESTABLECIMIENTO}</TableCell>
                                <TableCell>
                                    <Text>{item.TOTAL_MATRICULA_C}</Text>
                                </TableCell>
                            </TableRow>
                        ))}
                    </TableBody>
