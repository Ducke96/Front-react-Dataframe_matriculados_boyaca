...
const ThirdQuestion = () => {
    ...
    let categories = ["Aceleración del Aprendizaj", "Ciclo 1 Adultos", "13º Normal", "Ciclo 2 Adultos", "12º Normal", "Prejardín", "Ciclo 5 Adultos", 
    "Ciclo 3 Adultos" , "Jardín I" , "Ciclo 4 Adultos" , "Ciclo 6 Adultos" , "Once" , "Transición","Decimo" , "Noveno" , "Primero" , "Segundo" , "Tercero" , "Cuarto" , "Quinto", "Sexto" , "Septimo" , "Octavo"]
    let id = 1;
    ...
    return (
        <>
            ...
            <h2 className='flex items-center pt-10 pb-4 text-2xl font-semibold opacity-60 gap-x-2'>
                ...
                Matriculados por año para los diferentes niveles de formacion años 2020 a 2021
            </h2>
                    ...
                    <Table className="max-h-96 overscroll-none mt-6">
                        <TableHead>
                            <TableRow>
                                ...
                                <TableHeaderCell className="bg-white text-right">Matriculados</TableHeaderCell>
                            </TableRow>
                        </TableHead>
