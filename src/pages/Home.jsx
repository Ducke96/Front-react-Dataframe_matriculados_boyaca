    ...
    return (
        <Container className='relative pt-20 pb-16 text-center lg:pt-32'>
            ...
            <p className='max-w-xl mx-auto mt-6 text-lg tracking-tight text-slate-700'>
                Cada página del informe muestra preguntas de interés sobre las instituciones educativas en el departemento de Boyaca 
                El dataset utilizado es reportado por datos abiertos de colombia
                La información mostrada corresponde al periodo comprendido entre los años 2020 y 2021 años posteriores a la pandemia COVID-19
            </p>
