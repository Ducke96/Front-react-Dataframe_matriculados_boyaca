...
const secondQuestionData = await fetchData('second_question/')
    ...
    return (
        <>
            ...
            <h2 className='flex items-center pt-10 pb-4 text-2xl font-semibold opacity-60 gap-x-2'>
                ...
                ¿Cuántas IE rurales y urbanas reportan estudiantes matriculados para el periodo 2020 y 2021?
